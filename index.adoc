...
| Pre-conditions | *Capability* -- the current card type supports system block access.
| Errors      | None.
|===
...
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the block address is within range and the key number is valid. +
...
| Returns     | The current instance (<<type_StorageCardSelectionExtension,`StorageCardSelectionExtension`>>).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the block address is within range and the key is exactly 6 bytes long. +
  *Capability* -- the current card type supports authentication.
| Errors      | None.
|===
...
| Returns     | The current instance (<<type_StorageCardSelectionExtension,`StorageCardSelectionExtension`>>).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the block address is within range.
| Errors      | None.
...
| Returns     | The current instance (<<type_StorageCardSelectionExtension,`StorageCardSelectionExtension`>>).
| Pre-conditions | *Capability* -- the current card type is ST25/SRT512.
| Errors      | None.
