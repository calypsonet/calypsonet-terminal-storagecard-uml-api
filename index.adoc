...
| Signature
| `getBlocks(` +
`{nbsp}{nbsp}{nbsp}{nbsp}fromBlockAddress: integer,` +
`{nbsp}{nbsp}{nbsp}{nbsp}toBlockAddress: integer` +
`) -> byte array`
| Since       | 1.0
| Description
...
`{nbsp}{nbsp}{nbsp}{nbsp}blockAddress: integer,` +
`{nbsp}{nbsp}{nbsp}{nbsp}mifareClassicKeyType: MifareClassicKeyType,` +
`{nbsp}{nbsp}{nbsp}{nbsp}keyNumber: integer` +
`) -> StorageCardSelectionExtension`
| Since       | 1.1
| Description
...
`{nbsp}{nbsp}{nbsp}{nbsp}blockAddress: integer,` +
`{nbsp}{nbsp}{nbsp}{nbsp}mifareClassicKeyType: MifareClassicKeyType,` +
`{nbsp}{nbsp}{nbsp}{nbsp}key: byte array` +
`) -> StorageCardSelectionExtension`
| Since       | 1.1
| Description
